...
Put the package under your project folder in a directory named `rust_eveonline_esi` and add the following to `Cargo.toml` under `[dependencies]`:

```
rust_eveonline_esi = { path = "./rust_eveonline_esi" }
```
