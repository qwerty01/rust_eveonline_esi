...
pub async fn get_wars(
    configuration: &configuration::Configuration,
    params: GetWarsParams,
) -> Result<ResponseContent<GetWarsSuccess>, Error<GetWarsError>> {
    ...
    if let Some(ref local_var_str) = max_war_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("max_war_id", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetWarsSuccess> =
...
pub async fn get_wars_war_id(
    configuration: &configuration::Configuration,
    params: GetWarsWarIdParams,
) -> Result<ResponseContent<GetWarsWarIdSuccess>, Error<GetWarsWarIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetWarsWarIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetWarsWarIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_wars_war_id_killmails(
    configuration: &configuration::Configuration,
    params: GetWarsWarIdKillmailsParams,
) -> Result<ResponseContent<GetWarsWarIdKillmailsSuccess>, Error<GetWarsWarIdKillmailsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetWarsWarIdKillmailsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetWarsWarIdKillmailsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
