...
pub async fn get_characters_character_id_industry_jobs(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdIndustryJobsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdIndustryJobsSuccess>,
    Error<GetCharactersCharacterIdIndustryJobsError>,
> {
    ...
    if let Some(ref local_var_str) = include_completed {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_completed", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdIndustryJobsSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdIndustryJobsError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_characters_character_id_mining(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdMiningParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdMiningSuccess>,
    Error<GetCharactersCharacterIdMiningError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdMiningSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdMiningError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporation_corporation_id_mining_extractions(
    configuration: &configuration::Configuration,
    params: GetCorporationCorporationIdMiningExtractionsParams,
) -> Result<
    ResponseContent<GetCorporationCorporationIdMiningExtractionsSuccess>,
    Error<GetCorporationCorporationIdMiningExtractionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationCorporationIdMiningExtractionsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationCorporationIdMiningExtractionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporation_corporation_id_mining_observers(
    configuration: &configuration::Configuration,
    params: GetCorporationCorporationIdMiningObserversParams,
) -> Result<
    ResponseContent<GetCorporationCorporationIdMiningObserversSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationCorporationIdMiningObserversSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationCorporationIdMiningObserversError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporation_corporation_id_mining_observers_observer_id(
    configuration: &configuration::Configuration,
    params: GetCorporationCorporationIdMiningObserversObserverIdParams,
) -> Result<
    ResponseContent<GetCorporationCorporationIdMiningObserversObserverIdSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationCorporationIdMiningObserversObserverIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationCorporationIdMiningObserversObserverIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporations_corporation_id_industry_jobs(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdIndustryJobsParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdIndustryJobsSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdIndustryJobsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdIndustryJobsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_industry_facilities(
    configuration: &configuration::Configuration,
    params: GetIndustryFacilitiesParams,
) -> Result<ResponseContent<GetIndustryFacilitiesSuccess>, Error<GetIndustryFacilitiesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetIndustryFacilitiesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetIndustryFacilitiesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_industry_systems(
    configuration: &configuration::Configuration,
    params: GetIndustrySystemsParams,
) -> Result<ResponseContent<GetIndustrySystemsSuccess>, Error<GetIndustrySystemsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetIndustrySystemsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetIndustrySystemsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
