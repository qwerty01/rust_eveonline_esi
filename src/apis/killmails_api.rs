...
pub async fn get_characters_character_id_killmails_recent(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdKillmailsRecentParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdKillmailsRecentSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdKillmailsRecentSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdKillmailsRecentError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_corporations_corporation_id_killmails_recent(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdKillmailsRecentParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdKillmailsRecentSuccess>,
    Error<GetCorporationsCorporationIdKillmailsRecentError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdKillmailsRecentSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdKillmailsRecentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_killmails_killmail_id_killmail_hash(
    configuration: &configuration::Configuration,
    params: GetKillmailsKillmailIdKillmailHashParams,
) -> Result<
    ResponseContent<GetKillmailsKillmailIdKillmailHashSuccess>,
    Error<GetKillmailsKillmailIdKillmailHashError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        killmail_hash = crate::apis::urlencode(killmail_hash),
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetKillmailsKillmailIdKillmailHashSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetKillmailsKillmailIdKillmailHashError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
