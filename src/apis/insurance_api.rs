...
pub async fn get_insurance_prices(
    configuration: &configuration::Configuration,
    params: GetInsurancePricesParams,
) -> Result<ResponseContent<GetInsurancePricesSuccess>, Error<GetInsurancePricesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetInsurancePricesSuccess> =
        ...
        let local_var_entity: Option<GetInsurancePricesError> =
            serde_json::from_str(&local_var_content).ok();
