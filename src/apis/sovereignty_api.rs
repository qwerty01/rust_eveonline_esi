...
pub async fn get_sovereignty_campaigns(
    configuration: &configuration::Configuration,
    params: GetSovereigntyCampaignsParams,
) -> Result<ResponseContent<GetSovereigntyCampaignsSuccess>, Error<GetSovereigntyCampaignsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSovereigntyCampaignsSuccess> =
        ...
        let local_var_entity: Option<GetSovereigntyCampaignsError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_sovereignty_map(
    configuration: &configuration::Configuration,
    params: GetSovereigntyMapParams,
) -> Result<ResponseContent<GetSovereigntyMapSuccess>, Error<GetSovereigntyMapError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSovereigntyMapSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetSovereigntyMapError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sovereignty_structures(
    configuration: &configuration::Configuration,
    params: GetSovereigntyStructuresParams,
) -> Result<ResponseContent<GetSovereigntyStructuresSuccess>, Error<GetSovereigntyStructuresError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetSovereigntyStructuresSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetSovereigntyStructuresError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
