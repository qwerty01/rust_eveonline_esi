...
pub async fn get_characters_character_id_opportunities(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdOpportunitiesParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdOpportunitiesSuccess>,
    Error<GetCharactersCharacterIdOpportunitiesError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdOpportunitiesSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdOpportunitiesError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_opportunities_groups(
    configuration: &configuration::Configuration,
    params: GetOpportunitiesGroupsParams,
) -> Result<ResponseContent<GetOpportunitiesGroupsSuccess>, Error<GetOpportunitiesGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetOpportunitiesGroupsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetOpportunitiesGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_opportunities_groups_group_id(
    configuration: &configuration::Configuration,
    params: GetOpportunitiesGroupsGroupIdParams,
) -> Result<
    ResponseContent<GetOpportunitiesGroupsGroupIdSuccess>,
    Error<GetOpportunitiesGroupsGroupIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetOpportunitiesGroupsGroupIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetOpportunitiesGroupsGroupIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_opportunities_tasks(
    configuration: &configuration::Configuration,
    params: GetOpportunitiesTasksParams,
) -> Result<ResponseContent<GetOpportunitiesTasksSuccess>, Error<GetOpportunitiesTasksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetOpportunitiesTasksSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetOpportunitiesTasksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_opportunities_tasks_task_id(
    configuration: &configuration::Configuration,
    params: GetOpportunitiesTasksTaskIdParams,
) -> Result<
    ResponseContent<GetOpportunitiesTasksTaskIdSuccess>,
    Error<GetOpportunitiesTasksTaskIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetOpportunitiesTasksTaskIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetOpportunitiesTasksTaskIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
