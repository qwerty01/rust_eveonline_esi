...
pub async fn get_incursions(
    configuration: &configuration::Configuration,
    params: GetIncursionsParams,
) -> Result<ResponseContent<GetIncursionsSuccess>, Error<GetIncursionsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetIncursionsSuccess> =
        ...
        let local_var_entity: Option<GetIncursionsError> =
            serde_json::from_str(&local_var_content).ok();
