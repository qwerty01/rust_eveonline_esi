...
pub async fn delete_characters_character_id_mail_labels_label_id(
    configuration: &configuration::Configuration,
    params: DeleteCharactersCharacterIdMailLabelsLabelIdParams,
) -> Result<
    ResponseContent<DeleteCharactersCharacterIdMailLabelsLabelIdSuccess>,
    Error<DeleteCharactersCharacterIdMailLabelsLabelIdError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCharactersCharacterIdMailLabelsLabelIdSuccess> =
        ...
        let local_var_entity: Option<DeleteCharactersCharacterIdMailLabelsLabelIdError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn delete_characters_character_id_mail_mail_id(
    configuration: &configuration::Configuration,
    params: DeleteCharactersCharacterIdMailMailIdParams,
) -> Result<
    ResponseContent<DeleteCharactersCharacterIdMailMailIdSuccess>,
    Error<DeleteCharactersCharacterIdMailMailIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCharactersCharacterIdMailMailIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<DeleteCharactersCharacterIdMailMailIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_characters_character_id_mail(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdMailParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdMailSuccess>,
...
> {
    ...
    if let Some(ref local_var_str) = last_mail_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("last_mail_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = token {
        local_var_req_builder =
            local_var_req_builder.query(&[("token", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdMailSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdMailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_characters_character_id_mail_labels(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdMailLabelsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdMailLabelsSuccess>,
    Error<GetCharactersCharacterIdMailLabelsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdMailLabelsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdMailLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_characters_character_id_mail_lists(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdMailListsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdMailListsSuccess>,
    Error<GetCharactersCharacterIdMailListsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdMailListsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdMailListsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_characters_character_id_mail_mail_id(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdMailMailIdParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdMailMailIdSuccess>,
    Error<GetCharactersCharacterIdMailMailIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdMailMailIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdMailMailIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_characters_character_id_mail(
    configuration: &configuration::Configuration,
    params: PostCharactersCharacterIdMailParams,
) -> Result<
    ResponseContent<PostCharactersCharacterIdMailSuccess>,
    Error<PostCharactersCharacterIdMailError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCharactersCharacterIdMailSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCharactersCharacterIdMailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_characters_character_id_mail_labels(
    configuration: &configuration::Configuration,
    params: PostCharactersCharacterIdMailLabelsParams,
) -> Result<
    ResponseContent<PostCharactersCharacterIdMailLabelsSuccess>,
    Error<PostCharactersCharacterIdMailLabelsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCharactersCharacterIdMailLabelsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCharactersCharacterIdMailLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn put_characters_character_id_mail_mail_id(
    configuration: &configuration::Configuration,
    params: PutCharactersCharacterIdMailMailIdParams,
) -> Result<
    ResponseContent<PutCharactersCharacterIdMailMailIdSuccess>,
    Error<PutCharactersCharacterIdMailMailIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PutCharactersCharacterIdMailMailIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PutCharactersCharacterIdMailMailIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
