...
pub async fn get_characters_character_id_location(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdLocationParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdLocationSuccess>,
    Error<GetCharactersCharacterIdLocationError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdLocationSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdLocationError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_characters_character_id_online(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdOnlineParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdOnlineSuccess>,
    Error<GetCharactersCharacterIdOnlineError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdOnlineSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdOnlineError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_characters_character_id_ship(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdShipParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdShipSuccess>,
    Error<GetCharactersCharacterIdShipError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdShipSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdShipError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
