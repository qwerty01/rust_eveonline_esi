...
pub async fn get_characters_character_id_wallet(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdWalletParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdWalletSuccess>,
    Error<GetCharactersCharacterIdWalletError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdWalletSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdWalletError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_characters_character_id_wallet_journal(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdWalletJournalParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdWalletJournalSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdWalletJournalSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdWalletJournalError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_characters_character_id_wallet_transactions(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdWalletTransactionsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdWalletTransactionsSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdWalletTransactionsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdWalletTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporations_corporation_id_wallets(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdWalletsParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdWalletsSuccess>,
    Error<GetCorporationsCorporationIdWalletsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdWalletsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdWalletsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporations_corporation_id_wallets_division_journal(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdWalletsDivisionJournalParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdWalletsDivisionJournalSuccess>,
    Error<GetCorporationsCorporationIdWalletsDivisionJournalError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdWalletsDivisionJournalSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdWalletsDivisionJournalError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporations_corporation_id_wallets_division_transactions(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdWalletsDivisionTransactionsParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdWalletsDivisionTransactionsSuccess>,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<
            GetCorporationsCorporationIdWalletsDivisionTransactionsSuccess,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdWalletsDivisionTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
