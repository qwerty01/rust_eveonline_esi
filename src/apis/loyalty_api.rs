...
pub async fn get_characters_character_id_loyalty_points(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdLoyaltyPointsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdLoyaltyPointsSuccess>,
    Error<GetCharactersCharacterIdLoyaltyPointsError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdLoyaltyPointsSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdLoyaltyPointsError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_loyalty_stores_corporation_id_offers(
    configuration: &configuration::Configuration,
    params: GetLoyaltyStoresCorporationIdOffersParams,
) -> Result<
    ResponseContent<GetLoyaltyStoresCorporationIdOffersSuccess>,
    Error<GetLoyaltyStoresCorporationIdOffersError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetLoyaltyStoresCorporationIdOffersSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetLoyaltyStoresCorporationIdOffersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
