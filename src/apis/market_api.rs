...
pub async fn get_characters_character_id_orders(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdOrdersParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdOrdersSuccess>,
    Error<GetCharactersCharacterIdOrdersError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdOrdersSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdOrdersError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_characters_character_id_orders_history(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdOrdersHistoryParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdOrdersHistorySuccess>,
    Error<GetCharactersCharacterIdOrdersHistoryError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdOrdersHistorySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdOrdersHistoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporations_corporation_id_orders(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdOrdersParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdOrdersSuccess>,
    Error<GetCorporationsCorporationIdOrdersError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdOrdersSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdOrdersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_corporations_corporation_id_orders_history(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdOrdersHistoryParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdOrdersHistorySuccess>,
    Error<GetCorporationsCorporationIdOrdersHistoryError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdOrdersHistorySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdOrdersHistoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_groups(
    configuration: &configuration::Configuration,
    params: GetMarketsGroupsParams,
) -> Result<ResponseContent<GetMarketsGroupsSuccess>, Error<GetMarketsGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsGroupsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsGroupsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_groups_market_group_id(
    configuration: &configuration::Configuration,
    params: GetMarketsGroupsMarketGroupIdParams,
) -> Result<
    ResponseContent<GetMarketsGroupsMarketGroupIdSuccess>,
    Error<GetMarketsGroupsMarketGroupIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsGroupsMarketGroupIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsGroupsMarketGroupIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_prices(
    configuration: &configuration::Configuration,
    params: GetMarketsPricesParams,
) -> Result<ResponseContent<GetMarketsPricesSuccess>, Error<GetMarketsPricesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsPricesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsPricesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_region_id_history(
    configuration: &configuration::Configuration,
    params: GetMarketsRegionIdHistoryParams,
) -> Result<ResponseContent<GetMarketsRegionIdHistorySuccess>, Error<GetMarketsRegionIdHistoryError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsRegionIdHistorySuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsRegionIdHistoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_region_id_orders(
    configuration: &configuration::Configuration,
    params: GetMarketsRegionIdOrdersParams,
) -> Result<ResponseContent<GetMarketsRegionIdOrdersSuccess>, Error<GetMarketsRegionIdOrdersError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsRegionIdOrdersSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsRegionIdOrdersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_region_id_types(
    configuration: &configuration::Configuration,
    params: GetMarketsRegionIdTypesParams,
) -> Result<ResponseContent<GetMarketsRegionIdTypesSuccess>, Error<GetMarketsRegionIdTypesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsRegionIdTypesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsRegionIdTypesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_markets_structures_structure_id(
    configuration: &configuration::Configuration,
    params: GetMarketsStructuresStructureIdParams,
) -> Result<
    ResponseContent<GetMarketsStructuresStructureIdSuccess>,
    Error<GetMarketsStructuresStructureIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetMarketsStructuresStructureIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetMarketsStructuresStructureIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
