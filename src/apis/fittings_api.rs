...
pub async fn delete_characters_character_id_fittings_fitting_id(
    configuration: &configuration::Configuration,
    params: DeleteCharactersCharacterIdFittingsFittingIdParams,
) -> Result<
    ResponseContent<DeleteCharactersCharacterIdFittingsFittingIdSuccess>,
    Error<DeleteCharactersCharacterIdFittingsFittingIdError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCharactersCharacterIdFittingsFittingIdSuccess> =
        ...
        let local_var_entity: Option<DeleteCharactersCharacterIdFittingsFittingIdError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_characters_character_id_fittings(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdFittingsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdFittingsSuccess>,
    Error<GetCharactersCharacterIdFittingsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdFittingsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCharactersCharacterIdFittingsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_characters_character_id_fittings(
    configuration: &configuration::Configuration,
    params: PostCharactersCharacterIdFittingsParams,
) -> Result<
    ResponseContent<PostCharactersCharacterIdFittingsSuccess>,
    Error<PostCharactersCharacterIdFittingsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCharactersCharacterIdFittingsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCharactersCharacterIdFittingsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
