...
pub async fn get_alliances(
    ...
    params: GetAlliancesParams,
) -> Result<ResponseContent<GetAlliancesSuccess>, Error<GetAlliancesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAlliancesSuccess> =
        ...
        let local_var_entity: Option<GetAlliancesError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_alliances_alliance_id(
    configuration: &configuration::Configuration,
    params: GetAlliancesAllianceIdParams,
) -> Result<ResponseContent<GetAlliancesAllianceIdSuccess>, Error<GetAlliancesAllianceIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAlliancesAllianceIdSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetAlliancesAllianceIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_alliances_alliance_id_corporations(
    configuration: &configuration::Configuration,
    params: GetAlliancesAllianceIdCorporationsParams,
) -> Result<
    ResponseContent<GetAlliancesAllianceIdCorporationsSuccess>,
    Error<GetAlliancesAllianceIdCorporationsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAlliancesAllianceIdCorporationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetAlliancesAllianceIdCorporationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_alliances_alliance_id_icons(
    configuration: &configuration::Configuration,
    params: GetAlliancesAllianceIdIconsParams,
) -> Result<
    ResponseContent<GetAlliancesAllianceIdIconsSuccess>,
    Error<GetAlliancesAllianceIdIconsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetAlliancesAllianceIdIconsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetAlliancesAllianceIdIconsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
