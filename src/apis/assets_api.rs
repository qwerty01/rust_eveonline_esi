...
pub async fn get_characters_character_id_assets(
    configuration: &configuration::Configuration,
    params: GetCharactersCharacterIdAssetsParams,
) -> Result<
    ResponseContent<GetCharactersCharacterIdAssetsSuccess>,
    Error<GetCharactersCharacterIdAssetsError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCharactersCharacterIdAssetsSuccess> =
        ...
        let local_var_entity: Option<GetCharactersCharacterIdAssetsError> =
            serde_json::from_str(&local_var_content).ok();
...
pub async fn get_corporations_corporation_id_assets(
    configuration: &configuration::Configuration,
    params: GetCorporationsCorporationIdAssetsParams,
) -> Result<
    ResponseContent<GetCorporationsCorporationIdAssetsSuccess>,
    Error<GetCorporationsCorporationIdAssetsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetCorporationsCorporationIdAssetsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<GetCorporationsCorporationIdAssetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_characters_character_id_assets_locations(
    configuration: &configuration::Configuration,
    params: PostCharactersCharacterIdAssetsLocationsParams,
) -> Result<
    ResponseContent<PostCharactersCharacterIdAssetsLocationsSuccess>,
    Error<PostCharactersCharacterIdAssetsLocationsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCharactersCharacterIdAssetsLocationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCharactersCharacterIdAssetsLocationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_characters_character_id_assets_names(
    configuration: &configuration::Configuration,
    params: PostCharactersCharacterIdAssetsNamesParams,
) -> Result<
    ResponseContent<PostCharactersCharacterIdAssetsNamesSuccess>,
    Error<PostCharactersCharacterIdAssetsNamesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCharactersCharacterIdAssetsNamesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCharactersCharacterIdAssetsNamesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_corporations_corporation_id_assets_locations(
    configuration: &configuration::Configuration,
    params: PostCorporationsCorporationIdAssetsLocationsParams,
) -> Result<
    ResponseContent<PostCorporationsCorporationIdAssetsLocationsSuccess>,
    Error<PostCorporationsCorporationIdAssetsLocationsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCorporationsCorporationIdAssetsLocationsSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCorporationsCorporationIdAssetsLocationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_corporations_corporation_id_assets_names(
    configuration: &configuration::Configuration,
    params: PostCorporationsCorporationIdAssetsNamesParams,
) -> Result<
    ResponseContent<PostCorporationsCorporationIdAssetsNamesSuccess>,
    Error<PostCorporationsCorporationIdAssetsNamesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<PostCorporationsCorporationIdAssetsNamesSuccess> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent {
            status: local_var_status,
            content: local_var_content,
        ...
        let local_var_entity: Option<PostCorporationsCorporationIdAssetsNamesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
