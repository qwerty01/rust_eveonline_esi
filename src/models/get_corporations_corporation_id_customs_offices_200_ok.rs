...
pub struct GetCorporationsCorporationIdCustomsOffices200Ok {
    ...
    #[serde(
        rename = "terrible_standing_tax_rate",
        skip_serializing_if = "Option::is_none"
    )]
