...
impl GetFwLeaderboardsCharactersKills {
    ...
    pub fn new(
        active_total: Vec<crate::models::GetFwLeaderboardsCharactersActiveTotalActiveTotal>,
        last_week: Vec<crate::models::GetFwLeaderboardsCharactersLastWeekLastWeek>,
        yesterday: Vec<crate::models::GetFwLeaderboardsCharactersYesterdayYesterday>,
