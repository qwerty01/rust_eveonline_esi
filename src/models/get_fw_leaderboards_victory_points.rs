...
impl GetFwLeaderboardsVictoryPoints {
    ...
    pub fn new(
        active_total: Vec<crate::models::GetFwLeaderboardsActiveTotalActiveTotal1>,
        last_week: Vec<crate::models::GetFwLeaderboardsLastWeekLastWeek1>,
        yesterday: Vec<crate::models::GetFwLeaderboardsYesterdayYesterday1>,
