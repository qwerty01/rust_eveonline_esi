...
impl GetDogmaDynamicItemsTypeIdItemIdOk {
    ...
    pub fn new(
        created_by: i32,
        dogma_attributes: Vec<crate::models::GetDogmaDynamicItemsTypeIdItemIdDogmaAttribute>,
        dogma_effects: Vec<crate::models::GetDogmaDynamicItemsTypeIdItemIdDogmaEffect>,
        mutator_type_id: i32,
        source_type_id: i32,
