...
impl GetFwLeaderboardsCharactersVictoryPoints {
    ...
    pub fn new(
        active_total: Vec<crate::models::GetFwLeaderboardsCharactersActiveTotalActiveTotal1>,
        last_week: Vec<crate::models::GetFwLeaderboardsCharactersLastWeekLastWeek1>,
        yesterday: Vec<crate::models::GetFwLeaderboardsCharactersYesterdayYesterday1>,
