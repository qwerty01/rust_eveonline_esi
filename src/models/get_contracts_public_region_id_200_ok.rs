...
impl GetContractsPublicRegionId200Ok {
    /// 200 ok object
    pub fn new(contract_id: i32, date_expired: String, date_issued: String, issuer_corporation_id: i32, issuer_id: i32, r#type: RHashType) -> GetContractsPublicRegionId200Ok {
